    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-(--cell-size) aria-disabled:opacity-50 p-0 select-none rounded-none",
