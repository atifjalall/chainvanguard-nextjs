...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50 dark:from-slate-950 dark:via-blue-950 dark:to-cyan-950 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 flex h-16 items-center justify-between">
          ...
          <nav className="flex items-center space-x-4">
            ...
            <Link href="/login">
              <Button
                variant="ghost"
                className="text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-white/50 dark:hover:bg-gray-800/50 cursor-pointer transition-all duration-300"
              >
                Login
              </Button>
            </Link>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <Card
                key={idx}
                className="group border-0 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105 bg-white/90 dark:bg-gray-950/90 backdrop-blur-xl cursor-pointer relative overflow-hidden"
              >
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <Card
                key={idx}
                className="text-center border-0 shadow-xl bg-white/90 dark:bg-gray-950/90 backdrop-blur-xl transform transition-all duration-500 hover:scale-105 group cursor-pointer"
              >
      ...
      <section className="py-24 relative">
        <div className="container mx-auto px-6">
          <Card className="border-0 shadow-2xl bg-white/90 dark:bg-gray-950/90 backdrop-blur-xl relative overflow-hidden">
