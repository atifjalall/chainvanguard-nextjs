...
export default function VendorSavedItemsPage() {
  ...
  const totalPagesFiltered = Math.ceil(filteredInventory.length / itemsPerPage);
  ...
  const getPageNumbers = () => {
    ...
    const end = Math.min(totalPagesFiltered, start + maxVisiblePages - 1);
    ...
    if (end < totalPagesFiltered) {
      if (end < totalPagesFiltered - 1) pages.push("ellipsis-end");
      pages.push(totalPagesFiltered);
    }
            ...
            <Card className="text-center py-16 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 rounded-none shadow-none">
              <CardContent>
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
                  You haven&apos;t saved any items yet. Browse inventory to add
                  some.
                </p>
                <Button
                ...
                <PaginationContent>
                  ...
                  <PaginationItem>
                    <PaginationNext
                      onClick={() =>
                        setCurrentPage(
                          Math.min(totalPagesFiltered, currentPage + 1)
                        )
                      }
                      className={cn(
